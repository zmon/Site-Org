...
DEFINE('LIB_PATH', ROOT . '/ccmac/library');								// Create global variable to our library	
...
DEFINE('ASSETS_PATH', 'ccmac/assets');									// Create global variable to our css and js assets	
